  ...
  return (
    <>
      <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
        <nav>
          <h6 className="footer-title" targe="_blank">
            Company
          </h6>
      ...
      <footer className="footer bg-base-200 text-base-content border-base-300 border-t px-10 py-4">
        <aside className="grid-flow-col items-center">
          <img src="/navlogo.png" alt="logo" width={30} height={30} />
          {/* <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <nav className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            <a
              href="https://x.com/FrugalTesting"
              target="_blank"
            ...
            <a
              href="https://www.youtube.com/channel/UCjikgYGfeqU4ZPKQNm1V5tg"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              href="https://www.facebook.com/FrugalTest/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
